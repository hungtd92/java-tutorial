...
public final class PasswordGeneratorBackup {
  ...
  private PasswordGeneratorBackup() {
    throw new UnsupportedOperationException("Empty constructor is not supported.");
  }

  private PasswordGeneratorBackup(PasswordGeneratorBuilder builder) {
  ...
  public static class PasswordGeneratorBuilder {
    ...
    public PasswordGeneratorBackup build() {
      return new PasswordGeneratorBackup(this);
    }
  }
  ...
  public String generate(int length) {
    ...
    if (usePunctuation) {
      String[] array = PUNCTUATION.split("\\|", -1);
      List<Integer> givenList = Arrays.asList(1, 2, 3);
      Random rand = new Random();
      int randomElement = givenList.get(rand.nextInt(array.length));
